...
@Component({
  selector: 'jhi-doc-modification-log',
  templateUrl: './doc-modification-log.component.html',
   styleUrls: ['./doc-modification-log.component.scss']
})
export class DocModificationLogComponent implements OnInit, OnDestroy {
