...
@Component({
  ...
  template: `
    <div id="strength" class="d-flex flex-column align-items-center">
      <small jhiTranslate="global.messages.validate.newpassword.strength" class="levelMsg">Password strength:</small>
      <ul id="strengthBar" class="p-0 m-0">
        <li class="point"></li>
        <li class="point"></li>
        <li class="point"></li>
        <li class="point"></li>
