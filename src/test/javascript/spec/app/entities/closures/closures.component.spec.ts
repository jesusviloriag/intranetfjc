...
import { ClosuresComponent } from 'app/entities/closures/closures.component';
...
describe('Component Tests', () => {
  describe('Closures Management Component', () => {
    let comp: ClosuresComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ClosuresComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.closures[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
