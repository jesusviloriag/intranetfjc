...
import { FindingComponent } from 'app/entities/finding/finding.component';
import { FindingService } from 'app/entities/finding/finding.service';
import { Finding } from 'app/shared/model/finding.model';

describe('Component Tests', () => {
  describe('Finding Management Component', () => {
    let comp: FindingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FindingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.findings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
